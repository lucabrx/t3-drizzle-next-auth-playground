...
import type { MySqlDatabase, MySqlSession, QueryResultHKT } from "drizzle-orm/mysql-core";
import { accounts,sessions,users,verificationTokens } from "../db/auth";

export function createDrizzleAdapter(db: MySqlDatabase<QueryResultHKT,MySqlSession>): Adapter {
  return {
